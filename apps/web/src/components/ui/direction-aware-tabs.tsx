...
function DirectionAwareTabs({
  ...
  return (
    <div className=" flex flex-col items-center w-full">
      <div
        className={cn(
          "flex space-x-1 rounded-full cursor-pointer border border-border bg-neutral-900 px-[3px] py-[3.2px]",
          className,
          rounded
        )}
      >
          ...
          >
            {activeTab === tab.id && (
              <motion.span
                layoutId="bubble"
                className={cn(
                  "absolute inset-0 z-0 bg-neutral-800 border border-white/10",
